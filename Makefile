...
OPTIONS += -D__MK20DX128__ -DARDUINO=10600 -DTEENSYDUINO=121
...
CPPFLAGS = -Wall -g -Os -mcpu=cortex-m4 -mthumb -nostdlib -MMD $(OPTIONS) -I $(ARDUINOPATH)/hardware/teensy/avr/cores/teensy3/
...
# linker options
LDFLAGS = -Os -Wl,--gc-sections,--defsym=__rtc_localtime=0 --specs=nano.specs -mcpu=cortex-m4 -mthumb -Tmk20dx128.ld

# additional libraries to link
LIBS = -lm

VPATH=$(ARDUINOPATH)/hardware/teensy/avr/cores/teensy3
